                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-sm-6">
                                            ...
                                            <input class="form-control" id="nombre_teacher" value="{{ $teachers->nombre_teacher }}" required name="nombre_teacher" placeholder="" type="text">
                                        </div>
                                        <div class="form-group col-sm-3">
                                            <label for="materia">Materia</label>
                                            <select class="form-control" name="materia" id="materia">
                                                <option value="{{ $teachers->materia }}">{{ $teachers->materia }}</option>
                                        ...
                                        <div class="form-group col-sm-3">
                                            ...
                                            <input class="form-control" id="aula" required name="aula" value="{{ $teachers->aula }}" placeholder="" type="text">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-sm-12">
                                            <label for="dni">Horario</label>
                                            <input class="form-control" id="horario" required value="{{ $teachers->horario }}" name="horario" placeholder="" type="text">
                                        </div>
                                    </div>
                                </div>
