...
@section('pagina1', 'Editar Materia')
...
@section('content')
    ...
    <div class="col-lg-12">
        ...
        <form action="{{ route('materia.update',$materias->id) }}" method="POST">
            {{ csrf_field() }}
            {{ method_field('PATCH') }}
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $materias->nombre_materia }}" name="nombre_materia" id="nombre_materia" >
                                    </div>
                                </div>
